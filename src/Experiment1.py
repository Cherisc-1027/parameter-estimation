...
from src.SignalDetection1 import SignalDetection

class Experiment:
    def __init__(self, n_correct: List[int], n_incorrect: List[int]):
        """Initialize an experiment with correct and incorrect responses."""
